...
session_start();
  echo"<table border='2' cellpadding='10' bordercolor='red' align='center' class='result'>
<tr><td>Emp_ID</td><td>Emp Name</td><td>Email Id</td><td>Mobile No</td>
<td>Join Date</td><td>Job</td><td>Gender</td></tr>";

echo "<tr><td>".$_SESSION['Emp_id']."</td><td>".$_SESSION['Emp_name'].
          "</td><td>".$_SESSION['Email_id']."</td><td>".$_SESSION['Mobile_no'].
		  "</td><td>".$_SESSION['Join_d']."</td><td>".$_SESSION['job']."</td><td>".$_SESSION['gender']."
		  </td></tr></table>";
