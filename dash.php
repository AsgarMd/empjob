  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="dash.html">Home</a>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="employee_list.html">Employee</a>
              </li>
              <li class="nav-item">
                ...
                <div class="input-group">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item list-group-item bg-primary link-light" href="#">Login</a></li>
                      <li><a class="dropdown-item bg-primary link-light" href="#">Sign up</a></li>
                      
                      <li><hr class="dropdown-divider"></li>
                      <li><a class="dropdown-item bg-primary link-light" href="#">Forget Password</a></li>
                    </ul>
                  </li>
        ...
        <div class="col-lg-3 col-md-3">
            <div class="card card-border">
                ...
                <div class="list-group list-group-flush">
                    <a href="employee_list.html" class="list-group-item list-group-item-primary">View all</a>
                </div>
            </div>
       </div>   
       <div class="col-lg-3 col-md-3">
